#!/bin/bash
# Build and publish versions 1.21.8-1.21.10 to Modrinth
# Usage: ./scripts/publish-versions-1.21.8-1.21.10.sh
...
VERSIONS=(
    ...
    "1.21.9|1.21.9+build.1|0.134.0+1.21.9"
    "1.21.10|1.21.10+build.3|0.138.3+1.21.10"
)

echo "========================================="
echo "Building and Publishing to Modrinth"
echo "Project: $MODRINTH_PROJECT_ID"
echo "Versions: 1.21.8, 1.21.9, 1.21.10"
echo "========================================="
echo ""
